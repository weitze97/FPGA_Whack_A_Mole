set_property IOSTANDARD LVCMOS33 [get_ports {pb_highscore}]
set_property IOSTANDARD LVCMOS33 [get_ports {pb_start}]
set_property IOSTANDARD LVCMOS33 [get_ports {pb_clear}]
set_property IOSTANDARD LVCMOS33 [get_ports {led_test_op}]
...
set_property PACKAGE_PIN T17 [get_ports {pb_highscore}]
...
set_property PACKAGE_PIN W19 [get_ports {pb_clear}]
set_property PACKAGE_PIN P1 [get_ports {led_test_op}]
